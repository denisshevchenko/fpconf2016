...
(declare-fun App.localPort$35$$35$rui () Int)
...
(declare-fun VV$35$$35$54 () Int)
(declare-fun x_Tuple71 () Int)
(declare-fun VV$35$$35$48 () Int)
(declare-fun GHC.Show.$36$fShowInt$35$$35$ryr () Int)
...
(declare-fun App.main$35$$35$run () Int)
...
(push 1)
(assert (and (= VV$35$$35$F$35$$35$1 22)))
(push 1)
(assert (not (and (<= 1024 VV$35$$35$F$35$$35$1) (<= VV$35$$35$F$35$$35$1 65535))))
(check-sat)
; SMT Says: Sat
(pop 1)
(pop 1)
